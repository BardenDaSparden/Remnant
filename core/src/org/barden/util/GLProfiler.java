...
public class GLProfiler{
	...
	static GLProfiler instance = null;
	...
	public static GLProfiler get(){
		if(instance == null)
			instance = new GLProfiler();
		return instance;
	}
	...
	public void print(){
		for(int i = 0; i < processedQueries.size(); i++){
			GPUTimeQuery query = processedQueries.get(i);
			System.out.println(getTab(query.nestedLevel) + "[" + query.name + "] = " + query.result + "ms");
		}
	}
...
class Query {
	...
	protected Query(int startHandle, int endHandle, String name){
